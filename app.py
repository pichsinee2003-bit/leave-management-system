...
<body>
    ...
    <script>
          ...
          function checkDepartmentCapacityOverlap(empId, startDateStr, endDateStr) {
              ...
              // นับจำนวนพนักงานทั้งหมดในแผนกเดียวกัน
              let deptEmpIds = [];
              ...
              // ตรวจสอบว่ามีพนักงานในแผนกคนไหนบ้างที่ลาในช่วงวันดังกล่าวแล้ว (สถานะ Approved หรือ Pending)
              ...
              requests.forEach(req => {
                  if (req.companyId === currentEmp.companyId && req.empId !== empId && (req.status === "Approved" || req.status === "Pending")) {
                      ...
                      if (reqEmp && reqEmp.dept === currentEmp.dept) {
                          ...
                          // เช็คช่วงเวลาทับซ้อน (Overlap Check)
              ...
              // รวมตัวผู้ลาคนปัจจุบันเข้าไปคำนวณด้วย
          ...
          function calculateDays() {
              ...
              // Trigger Live Smart Warning Check
          ...
          function handleLeaveSubmit(e) {
              ...
              // ตรวจสอบทับซ้อนและ Capacity เกิน 50% รอบสุดท้ายก่อนบันทึก
              ...
              const saveAndFinish = (fileDataUrl, fileName) => {
                  const newRequest = {
                      ...
                      approvedBy: "-",
                      rejectionReason: "",
                      hasCapacityWarning: isHighOverlap // บันทึกสถานะ Smart Warning ไว้ให้หัวหน้าเห็น
                  };
          ...
          function renderApproverTable(approverCompanyId) {
              ...
              requests.forEach(req => {
                  ...
                  // ป้ายเตือน Smart Warning สำหรับหน้าจอหัวหน้างาน
          ...
          function openDetailModal(requestId) {
              ...
              // แสดงเตือน Smart Warning ใน Modal ของหัวหน้าถ้ามีคนลาเกิน 50%
...
if __name__ == "__main__":
    print("กำลังเริ่มทำงานระบบ Leave Management System (พร้อม Smart Warning & Team Capacity Check)...")
